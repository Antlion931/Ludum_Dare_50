...
NPCCreator::NPCCreator(std::shared_ptr<CollisionLayer>& _collisionLayer, std::shared_ptr<YSort>& _ysort, std::shared_ptr<CollisionLayer>& _interactionLayer) 
    : collisionLayer(_collisionLayer), ysort(_ysort), interactionLayer(_interactionLayer)
{}
