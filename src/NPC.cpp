...
NPC::NPC(SoundSystem& soundSystem, sf::Vector2f position, sf::Vector2f size, float _speed, float _dyingTime, std::shared_ptr<CollisionLayer> _player_interaction_layer): 
